      ...
      <div className="container flex justify-between items-center absolute top-0 left-1/2 -translate-x-1/2 h-full z-20">
        ...
        <div className="w-[400px] rounded-lg bg-gray-50 p-6">
          ...
          <div className="grid gap-y-3">
            ...
            <button className="bg-blue-100 bg-opacity-50 h-12 px-4 flex items-center  rounded-lg w-full text-sm font-semibold flex justify-center text-facebook-color transition-colors hover:bg-blue-900 hover:text-white">
              <FaFacebook size={24} className="justify-self-start"/> <span className="mx-auto">Facebook ile devam et</span>
            </button>
          </div>
        </div>
      </div>
