  ...
  return (
    <div className="bg-white mt-10">
      <div className="container mx-auto px-4 md:px-0">
        ...
        <div className="flex flex-col md:flex-row gap-y-2 justify-between items-center border-t border-gray-100 mt-6 pt-6">
          <div className="text-xs text-gray-700 flex gap-x-8 mb-6">
            &copy; 2022 Getir
            <a
              href="#"
              className="text-primary-brand-color hover:underline relative before:w-1 before:h-1 before:bg-black before:absolute before:-left-4 before:top-1/2 before:-translate-y-1/2 before:rounded-full"
            >
